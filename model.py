...
class Members(SQLModel, table=True):
    ...
    access_card_id: int | None = Field(default=None, foreign_key="access_card_id")
...
class Registrations(SQLModel, table=True):
    ...
    member_id: str = Field(default=None, foreign_key="member_id")
    course_id: str = Field(default=None, foreign_key="course_id")
...
class Courses(SQLModel, table=True):
    ...
    coach_id: int | None = Field(default=None, foreign_key="coach_id")
